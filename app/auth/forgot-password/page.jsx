  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .fp-btn { transition: transform .2s cubic-bezier(0.34,1.56,0.64,1), box-shadow .2s !important; }
        .fp-btn:hover:not(:disabled) { transform: translateY(-2px) scale(1.015) !important; box-shadow: 0 10px 32px rgba(224,163,59,0.42) !important; }
      ...
      <div style={{ width: "100%", maxWidth: 360, animation: "blurUp .45s cubic-bezier(0.16,1,0.3,1) both" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 13, color: "#6B7280", margin: 0, fontFamily: "var(--font-myanmar, system-ui)",
            ...
            Email ဖြင့် Reset link ပို့ပေးပါမည်
          </p>
        </div>
          ...
          {sent ? (
            <div style={{ textAlign: "center", padding: "8px 0" }}>
              ...
              <p style={{
                ...
                {email} သို့ Password Reset link ပို့ပြီးပါပြီ။ Email စစ်ပါ။
              </p>
              <Link href="/auth/login" style={{
                display: "block", textAlign: "center", padding: "13px",
                borderRadius: 12, border: "1px solid #2C313C", color: "#ECE6D9",
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit" disabled={loading} className="fp-btn"
                style={{
        ...
        <p style={{ textAlign: "center", marginTop: 20, fontSize: 14, color: "#6B7280", fontFamily: "var(--font-myanmar, system-ui)" }}>
          <Link href="/auth/login" style={{ color: "#E0A33B", textDecoration: "none", fontWeight: 700 }}>
            ← Login သို့ ပြန်သွားမည်
          </Link>
        </p>
      </div>
