...
function SubmitBtn() {
  ...
  return (
    ...
    >
      {pending ? <><Spinner dark /> အကောင့် ဖွင့်နေသည်...</> : "အကောင့် ဖွင့်မည်"}
    </button>
  );
}
          ...
          <div style={{
            ...
            <form action={action}>
              ...
              <div style={{ marginBottom: 14, animation: "slideUp .4s .22s cubic-bezier(0.16,1,0.3,1) both" }}>
                ...
                <input className="auth-input" name="name" type="text" required minLength={2}
                  placeholder="ဥပမာ — ကိုမောင်" autoComplete="name"
              ...
              <div style={{ marginBottom: 14, animation: "slideUp .4s .34s cubic-bezier(0.16,1,0.3,1) both" }}>
                <label style={labelStyle}>ဖုန်းနံပါတ်</label>
                <input className="auth-input" name="phone" type="tel" required
              ...
              <div style={{ animation: "slideUp .4s .46s cubic-bezier(0.16,1,0.3,1) both" }}>
                <SubmitBtn />
              </div>
            </form>
